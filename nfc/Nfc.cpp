#define LOG_TAG "android.hardware.nfc@1.0-impl-qc199x"
...
#define NFC_NCI_QC199X_HARDWARE_MODULE_ID "nfc_nci.qc199x"
...
INfc* HIDL_FETCH_INfc(const char * /*name*/) {
    ...
    ret = hw_get_module (NFC_NCI_QC199X_HARDWARE_MODULE_ID, &hw_module);
    if (ret == 0) {
        ...
        ALOGE ("hw_get_module %s failed: %d", NFC_NCI_QC199X_HARDWARE_MODULE_ID, ret);
